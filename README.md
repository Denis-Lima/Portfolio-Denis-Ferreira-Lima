...
Para a construção do projeto, minha contribuição foi focada na criação do servidor teste em Java com SpringBoot. Toda sua estruturação, configuração, criação e mapeamento utilizando ORM, bem como regras de negócios, controllers, rotas, autenticação e toda a API-REST. Contribui também com pequenos empecilhos ao frontend da aplicação teste como ajuste de CSS, pequenas melhorias de usabilidade e componentização para reaproveitamento de código.  
Realizei a configuração básica do script para teste de carga e auxílio na criação do docker para o servidor.  
...
* Utilizar framework SpringBoot: Sei fazer com autonomia.  
* Desenvolvimento backend com ORM: Sei fazer com autonomia.  
* Programação Machine Learning com Python: Sei fazer com ajuda.  
* Utilizar banco de dados PostgreSQL: Sei fazer com autonomia.  
* Utilizar NGINX: Sei fazer com ajuda.  
* Utilizar Prometheus: Sei fazer com ajuda.  
* Utilizar Grafana: Sei fazer com ajuda.  
